...
import com.example.javasb.databinding.FragmentHtmlBinding;
...
public class HtmlFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        webView = (WebView) view.findViewById(R.id.simpleWebViewHTML);
        try {
            InputStream is = getActivity().getAssets().open("theme_html.html");
        ...
        String str = getArguments().getString("html");
