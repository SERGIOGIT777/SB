...
import com.example.javasb.databinding.FragmentDpBinding;
...
public class DpFragment extends Fragment {
    ...
    private FragmentDpBinding binding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        webView = (WebView) view.findViewById(R.id.simpleWebViewDP);
        try {
            InputStream is = getActivity().getAssets().open("dp.html");
        ...
        String str = getArguments().getString("dp");
