...
import com.example.javasb.databinding.FragmentSerialBinding;
...
public class SerialFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        webView = (WebView) view.findViewById(R.id.simpleWebViewSerial);
        try {
            InputStream is = getActivity().getAssets().open("jsz.html");
        ...
        String str = getArguments().getString("jsz");
