...
import com.example.javasb.databinding.FragmentOopBinding;
...
public class OopFragment extends Fragment {
    ...
    private FragmentOopBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOopBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        try {
            InputStream is = getActivity().getAssets().open("oop.html");
        ...
        String str = getArguments().getString("oop");
