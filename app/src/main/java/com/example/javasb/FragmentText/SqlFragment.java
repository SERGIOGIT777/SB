...
import com.example.javasb.databinding.FragmentSqlBinding;
...
public class SqlFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        webView = (WebView) view.findViewById(R.id.simpleWebViewSQL);
        try {
            InputStream is = getActivity().getAssets().open("sql.html");
        ...
        String str = getArguments().getString("sql");
